...
export default function DonorRecognition() {
  const topDonors: TopDonor[] = [
    { name: 'João R.', amount: 150, badge: 'Guardião da Liberdade', isMonthly: true },
    { name: 'Maria S.', amount: 75, badge: 'Sustentador', isMonthly: true },
    { name: 'Pedro M.', amount: 50, badge: 'Protetor', isMonthly: false },
    { name: 'Ana L.', amount: 45, badge: 'Sustentador', isMonthly: true },
    { name: 'Carlos F.', amount: 30, badge: 'Protetor', isMonthly: true }
  ];
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                <div className="text-2xl font-bold text-blue-900">284</div>
              ...
              <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                <div className="text-2xl font-bold text-purple-900">R$44</div>
