...
# Run this on the server: root@148.230.85.210

echo "🔧 Updating staging with apoiar routing fix..."
...
# Rebuild
npm run build && pm2 restart marchabrasil-staging

echo "✅ Staging updated with apoiar routing fix"